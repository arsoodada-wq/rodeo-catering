    ...
    <section className="relative overflow-hidden bg-ink-900 text-cream-50">
      ...
      <Container className="relative py-20 md:py-28">
        <div className="grid items-center gap-12 lg:grid-cols-[1.1fr_1fr]">
          ...
          <div className="relative hidden aspect-[8/5] overflow-hidden rounded-3xl shadow-2xl shadow-black/40 lg:block">
            <Image
              src="/images/rodeo/hero-food-spread.jpg"
              alt="A spread of Rodeo Burgers and Chicken smash burgers, wings, and sides"
              fill
